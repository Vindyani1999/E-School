...
class SubjectsActivity : AppCompatActivity() {
    ...
    private fun prepareSubjectsListData(selectedGrade: String?) {
        ...
        val gradeSubjectsMap = mapOf(
            ...
            "Grade 10" to listOf("English", "Art","Science", "Geography", "Technology", "Commerce","Sinhala","Health","History", "English"),
            "Grade 09" to listOf("History", "Health","Maths", "Technology", "Science", "Health","Sinhala","Art","Commerce", "English"),
            "Grade 08" to listOf("Maths", "History","Geography", "Technology", "Science", "Health","Sinhala","Art","Commerce", "English"),
